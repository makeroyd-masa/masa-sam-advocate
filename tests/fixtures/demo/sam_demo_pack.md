...
## 2. Flow 2 — Unbundling (one service includes another)

**2.1 Comprehensive + basic metabolic panel**
...
**4.2 New-patient visit at ~4× Medicare**
- **In SAM:** *Check it for errors & overcharges* → coverage *Self-pay*.
...
**5.2 Unbundled lipid panel + a ~4.5× visit**
- **In SAM:** *Check it for errors & overcharges* → coverage *Self-pay*.
...
**5.3 Unbundled CBC + a ~5.5× procedure**
- **In SAM:** *Check it for errors & overcharges* → coverage *Self-pay*.
...
## 6. Flow 3 — Ground ambulance appeal

**6.1 ALS1-emergency, Texas, 18 mi (Medicare)**
...
**6.2 ALS2, New York, 9 mi (Medicare Advantage)**
...
**6.3 Specialty care transport, Florida, 25 mi (Commercial)**
...
## 7. Flow 3 — Air ambulance (routes to a human)

**7.1 Rotary-wing air transport**
